...
var WeekSummaryTable_vue_1 = require("@components/transactions/WeekSummaryTable.vue");
...
describe('WeekSummaryTable', function () {
    ...
    test.skip('renders the WeekSummaryTable with the correct fields', function () { return __awaiter(_this, void 0, void 0, function () {
        var wrapper, store, table, columns, memo, weeklyAmountDebit;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    wrapper = (0, test_utils_1.mount)(WeekSummaryTable_vue_1.default, {
                        global: {
                            components: {
                ...
                case 1:
                    ...
                    memo = wrapper.find('[data-testid="memo-week-summary"]');
                    weeklyAmountDebit = wrapper.find('[data-testid="weekly-amount-debit"]');
                    return [2 /*return*/];
            }
        });
    }); });
