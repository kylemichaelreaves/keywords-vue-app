import { adjustSelected } from '@components/transactions/helpers/adjustSelected.ts'
...
describe('adjustSelected function', () => {
  ...
  it('should correctly adjust the selected day', () => {
    expect(adjustSelected('2022-01-01', dayYearMock, 1, 'day')).toBe('2022-01-02')
    expect(adjustSelected('2022-01-02', dayYearMock, -1, 'day')).toBe('2022-01-01')
  })
  ...
  it('should not adjust the selected item if it is the first or last in the array', () => {
    expect(adjustSelected('2022-01-01', dayYearMock, -1, 'day')).toBe('2022-01-01')
    expect(adjustSelected('2022-01-03', dayYearMock, 1, 'day')).toBe('2022-01-03')
  })
})
