...
var MonthSummaryTable_vue_1 = require("@components/transactions/MonthSummaryTable.vue");
...
beforeAll(function () {
    test_setup_1.server.listen();
});
// Reset any runtime request handlers
afterEach(function () {
    test_setup_1.server.resetHandlers();
});
// Clean up once the tests are done
afterAll(function () {
    test_setup_1.server.close();
});
describe('MonthSummaryTable', function () {
    var _this = this;
    test.skip('renders the MonthlySummaryTable with the correct fields', function () { return __awaiter(_this, void 0, void 0, function () {
        var wrapper, store, table, columns, memoValue, debitValue;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    wrapper = (0, test_utils_1.mount)(MonthSummaryTable_vue_1.default, {
                        global: {
                            components: {
                    ...
                    wrapper.vm.monthSummaryData = transaction_1.monthSummaryMock;
                ...
                case 1:
                    ...
                    memoValue = wrapper.find('[data-testid="memo-monthly-summary"]').text();
                    expect(memoValue).toBe(transaction_1.monthSummaryMock[0].memo);
                    debitValue = wrapper.find('[data-testid="monthly-amount-debit"]').text();
                    expect(debitValue).toBe(transaction_1.monthSummaryMock[0].monthly_amount_debit.toString());
                    return [2 /*return*/];
            }
        });
    }); });
