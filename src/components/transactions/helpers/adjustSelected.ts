...
export const adjustSelected = <T extends NavigationType & Record<keyof T, string>>(
  selected: string,
  items: T[],
  adjustment: number,
  key: keyof T,
...
export const goToPrevious = <T extends NavigationType & Record<keyof T, string>>(
  selected: string,
  items: T[],
  key: keyof T,
): string => {
...
export const goToNext = <T extends NavigationType & Record<keyof T, string>>(
  selected: string,
  items: T[],
  key: keyof T,
): string => {
