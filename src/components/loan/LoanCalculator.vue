<template>
  <el-card style="width: 35vw">
    ...
    <!--    <TableComponent-->
    <!--        v-if="isLoanEstimateCalculated && !isFormInItsInitialState"-->
    <!--        :table-data="Object.entries(loanEstimate).map(([k,v]) => `${v}`)"-->
    <!--        :columns="loanEstimateColumns"-->
    <!--    />-->
    <!--    TODO if loanEstimate, use a StatisticComponent for each of its fields -->
...
export default defineComponent({
  ...
  setup() {
    ...
    return {
      ...
      loanFormFields,
      hasFormChanged,
      isFormInItsInitialState,
      isLoanEstimateCalculated,
      loanEstimateColumns,
      ruleFormRef,
      rules
    };
